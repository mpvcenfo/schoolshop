...
botonModificar.addEventListener('click', modificarEstudiante);
...
function llenarEstudiante() {
	let id = obtenerIDEstudiante();

	let estudiante = obtenerEstudiante(id);

	inputIdentificacion.value = estudiante['identificacion'];
	inputNombre.value = estudiante['primerNombre'];
	inputSegundoNombre.value = estudiante['segundoNombre'];
	inputApellido.value = estudiante['primerApellido'];
	inputSegundoApellido.value = estudiante['segundoApellido'];
	inputTelPersonal.value = estudiante['telefonoPersonal'];
	inputFechaNacimiento.value = estudiante['fechaNacimiento'];
	inputDireccion.value = estudiante['direccion'];
	inputTelCasa.value = estudiante['telefonoResidencia'];
	inputGenero.value = estudiante['genero'].toLowerCase();
	inputGrupoSanguineo.value = estudiante['grupoSanguineo'].toLowerCase(); inputDonador.value = estudiante['donador'];
	inputBeca.value = estudiante['beca'];
	inputNombreContacto1.value = estudiante['nombreContacto1'];
	inputParentesco1.value = estudiante['parentescoContacto1'].toLowerCase();
	inputTelContacto1.value = estudiante['telefonoContacto1'];
	inputNombreContacto2.value = estudiante['nombreContacto2'];
	inputParentesco2.value = estudiante['parentescoContacto2'].toLowerCase();
	inputTelContacto2.value = estudiante['telefonoContacto2'];
	inputNombreContacto3.value = estudiante['nombreContacto3'];
	inputParentesco3.value = estudiante['parentescoContacto3'].toLowerCase();
	inputTelContacto3.value = estudiante['telefonoContacto3'];
	inputCondicionMedica.value = estudiante['condicionMedica'];
	inputInstitucion.value = estudiante['institucion'];
	inputNivel.value = estudiante['nivel'];
	inputSeccion.value = estudiante['seccion'];
