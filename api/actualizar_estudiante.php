...
$sentencia_sql = "CALL pa_actualizar_estudiante('$pidentificacion', '$pprimerNombre', '$psegundoNombre', '$pprimerApellido', '$psegundoApellido', '$ptelefonoPersonal', '$pfechaNacimiento', '$pdireccion', '$ptelefonoResidencia', '$pgenero', '$pgrupoSanguineo', '$pdonador', '$pimagen', '$pnombreContacto1', '$pparentescoContacto1', '$ptelefonoContacto1', '$pnombreContacto2', '$pparentescoContacto2', '$ptelefonoContacto2', '$pnombreContacto3', '$pparentescoContacto3', '$ptelefonoContacto3', '$pcondicionMedica', '$pcomprobante', '$pinstitucion', '$pnivel', '$pseccion')";
